...
* **Management Duty:** Leads the **UI**, **Shiny**, and **Narrative**, Guilds. Directs teams on styling.
...
* **Management Duty:** Leads the **Code** and **Data** guilds. Accepts/rejects Pull Requests from Feature Teams.
...
* **`global.R`**: Shared libraries and data loading (Read-Only).
