...
-   Read **Chapter 25 (Functions)** and **Chapter 26 (Iteration)** in *R for Data Science (2e)*.
-   Practice writing a simple function for a repetitive task in your assignments.
-   Try using `map()` next time you need to read multiple similar files.
